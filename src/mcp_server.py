...
from tools import TOOLS_SCHEMA, dispatch_tool_call, TOOLS_SCHEMA_HR_SUPPORT
...
class MCPAcademicServer:
    ...
    def list_tools(self) -> List[Dict[str, Any]]:
        ...
        return TOOLS_SCHEMA_HR_SUPPORT
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            content = {
                "status": "PARSE_ERROR",
                "error": f"Không thể parse kết quả trả về từ Tool Router: {str(e)}"
            }
...
if __name__ == "__main__":
    ...
    test_result = server.call_tool("get_candidate_status", {"candidate_id": "CV2026001"})
    if not test_result:
        print("⏳ [TODO 2.1]: Hàm call_tool() đang trả về rỗng. Học viên hãy hoàn thiện TODO 2.1 trong 'src/mcp_server.py'!")
    else:
        print(f"✅ [TODO 2.1]: Test dispatch tool 'get_candidate_status' thành công:")
